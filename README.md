...
* **SNI-SLAM**: Semantic Neural Implicit SLAM, *CVPR, 2024*. [[Paper](https://arxiv.org/pdf/2311.11016.pdf)]
...
* **Loopy-SLAM**: Dense Neural SLAM with Loop Closures, *arXiv, 2024*. [[Paper](https://arxiv.org/pdf/2402.09944.pdf)]
